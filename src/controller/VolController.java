...
public class VolController  {
	...
	String mge="le Processus est arret� Cliquez sur le bouton pour le d�marrer";
	@Autowired
	VolMetier services;
	...
	if(demarer==true) {
		...
		mge="le Processus est demarr� Cliquez sur le bouton pour l'arreter";
		demarer=false;
		...
		demarer=true;
		Demarre="Demarrer";
		mge="le Processus est arret� Cliquez sur le bouton pour le d�marrer";
		processus1.cancel();
